Multi-motor controller uses a raspberry pi pico to monitor analog and digital controls.

Interpretting this input, the RPi pico drives PWM on the input of sparkmax in order to spin the NEOs.
